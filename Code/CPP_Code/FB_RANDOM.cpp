...
void FORTE_FB_RANDOM::alg_REQ(void) {
  // #pragma GCC warning "Algorithm of type: 'AnyText' may lead to unexpected results!"
  // #pragma message ("warning Algorithm of type: 'AnyText' may lead to unexpected results!")
  st_VAL() = (TForteFloat) ((rand() % 32767) / 100000.0); // RAND_MAX is a constant defined in <cstdlib>. Its default value may vary between implementations but it is granted to be at least 32767.
}
